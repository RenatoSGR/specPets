---
title: Octopets - Pet Sitter MarketPlace Platform
description: A pet sitter marketplace platform that enables pet owners to search for and book pet sitters. Technically follows .NET Aspire orchestration with ASP.NET Core backend, React frontend, and multi-agent AI integration for intelligent recommendations.
category: AI Apps & Agents # AI Apps & Agents | App Modernization | Data Centric Apps
industry: Retail & Consumer Goods # Government & Public Sector Finantial Services | Healthcare & Life Sciences | Manufacturing | Retail & Consumer Goods | Government & Public Sector | Education | Energy & Resources | Telco & Media | Mobility & Automotive
languages: .NET | React #| Java | Go | TypeSscript | JavaScript
services: [Azure AI Foundry, Azure Container Services] # Full list here: https://azure.microsoft.com/en-us/products/
frameworks: [Aspire] # Microsoft Agent Framework | LangChain | Pydantic AI
